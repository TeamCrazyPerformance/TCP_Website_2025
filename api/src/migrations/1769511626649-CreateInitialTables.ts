...
export class CreateInitialTables1769511626649 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Progress" ("id" SERIAL NOT NULL, "title" text NOT NULL, "content" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "study_id" integer, CONSTRAINT "PK_050af20d7d2e640b410da789e1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Resource" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "format" character varying(10) NOT NULL, "dir_path" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "study_id" integer, CONSTRAINT "PK_c029bb9649165945fc2fa675de0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(50) NOT NULL, "password" character varying(255) NOT NULL, "name" character varying(50) NOT NULL, "student_number" character varying(20) NOT NULL, "profile_image" character varying(255) NOT NULL DEFAULT 'default_profile_image.png', "phone_number" character varying(20) NOT NULL, "email" character varying(255) NOT NULL, "major" character varying(100) NOT NULL, "join_year" smallint NOT NULL, "birth_date" date NOT NULL, "gender" "public"."user_gender_enum" NOT NULL DEFAULT 'Male', "role" "public"."user_role_enum" NOT NULL DEFAULT 'GUEST', "tech_stack" text array, "education_status" "public"."user_education_status_enum" NOT NULL DEFAULT '재학', "current_company" character varying(255), "baekjoon_username" character varying(255), "github_username" character varying(255), "self_description" text, "portfolio_link" character varying(255), "is_public_github_username" boolean NOT NULL DEFAULT false, "is_public_email" boolean NOT NULL DEFAULT false, "is_public_tech_stack" boolean NOT NULL DEFAULT false, "is_public_education_status" boolean NOT NULL DEFAULT false, "is_public_portfolio_link" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_305f99f34a214909d328147986c" UNIQUE ("student_number"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
