    ...
    >
      ...
      <nav className="space-y-4">
        ...
        <div>
          ...
          <Link
            to="/admin/tech-articles/reviews/duplicates"
            className={`sidebar-link ${isActive("/admin/tech-articles/reviews/duplicates") ? "bg-gray-700 text-white" : ""}`}
          >
            <i className="fas fa-code-compare"></i>
            <span className="ml-2">Suspected Duplicates</span>
          </Link>
          <Link
