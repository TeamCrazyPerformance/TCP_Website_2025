...
/**
 * Formats a date string into YYYY.MM.DD format (dot-separated).
 * Used for study period fields which require dot notation.
 * @param {string} value - The input value to format.
 * @returns {string} - The formatted date string with dots.
 */
