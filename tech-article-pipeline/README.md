...
no original publication timestamp, with an internal normalization warning that
marks the value as approximate. None of this metadata is inserted into
README-derived normalized content.
